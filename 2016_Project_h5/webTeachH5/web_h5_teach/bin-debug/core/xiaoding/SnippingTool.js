...
var SnippingTool = (function () {
    ...
    var d = __define,c=SnippingTool,p=c.prototype;
    //group 要截图的UI,callBack 截图成功时的回调，参数bitmapData
    p.snipping = function (group, callBack) {
        if (!group)
            return;
        this._group = group;
    ...
    p.onStageResize = function (event) {
    ...
    p.onClipCreateFinish = function () {
        this._rectBmp.mask = this._clipMask.rectMask;
    };
    p.onPhotoShare = function (e) {
        this.snipPhoto(2);
    };
    /*
     * type 1 截图  2截图并分享
     * */
    p.snipPhoto = function (type) {
    ...
    p.onConfirmSnipping = function (event) {
        this.snipPhoto(1);
    };
    p.onCancelSnipping = function (event) {
...
egret.registerClass(SnippingTool,'SnippingTool',["ISnippingTool"]);
var ClipMask = (function (_super) {
    ...
    var d = __define,c=ClipMask,p=c.prototype;
    ...
    p.bottomToolClick = function (commondType) {
    ...
    p.updateAdjustPosition = function () {
        if (this._clickClip) {
     ...
     * 工具条位置
     * */
    p.updateBottomToolPosition = function () {
        this._bounds = this._canvas.getBounds(new egret.Rectangle(0, 0, this.parent.width, this.parent.height));
        if (this._bottomTool) {
    ...
    //截图前要做的一些事情
    p.snippingBeforeSomeThing = function () {
        if (this._canvas) {
            this._canvas.graphics.clear();
        }
        if (this._clickClip) {
...
egret.registerClass(ClipMask,'ClipMask');
//控制点
var ControlBar = (function (_super) {
    ...
    var d = __define,c=ControlBar,p=c.prototype;
    p.destroy = function () {
        this.removeChildren();
        this._rect = null;
    };
...
egret.registerClass(ControlBar,'ControlBar');
var BottomTool = (function (_super) {
    __extends(BottomTool, _super);
    function BottomTool() {
        _super.call(this);
    }
    var d = __define,c=BottomTool,p=c.prototype;
    p.createChildren = function () {
        _super.prototype.createChildren.call(this);
    ...
    p.onClickHandler = function (event) {
...
egret.registerClass(BottomTool,'BottomTool');
