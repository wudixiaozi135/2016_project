 ...
 */
class BottomMenuGroup extends eui.Group implements IBottomMenuBtnPosition
{
	private _clickTime:number = 0;
	private _menuCallRoll:BottomMenuBtn;
	private _menuSnipping:BottomMenuBtn;
	private _menuColor:BottomMenuBtn;
	private _menuWord:BottomMenuBtn;
	private _menuEraser:BottomMenuBtn;
	private _menuChoose:BottomMenuBtn;
	private _menuBook:BottomMenuBtn;
	private _menuCloudDisk:BottomMenuBtn;
	private _menuHousework:BottomMenuBtn;
	private _menuSyncClass:BottomMenuBtn;
	private _menuStatistic:BottomMenuBtn;
	private _menuSave:BottomMenuBtn;

	private _bottomMenuHandler:BottomMenuHandler;
	...
	protected createChildren():void
	{
		...
		var horizonLayout:eui.HorizontalLayout = new eui.HorizontalLayout();
		...
		var leftGroup:eui.Group = xd.CommonUtils.getGroup(1, egret.VerticalAlign.MIDDLE, 10, [this._menuCallRoll, this._menuSnipping, this._menuColor, this._menuWord, this._menuEraser, this._menuChoose]);
		...
		var rightGroup:eui.Group = xd.CommonUtils.getGroup(1, egret.VerticalAlign.MIDDLE, 10, [this._menuBook, this._menuCloudDisk, this._menuHousework, this._menuSyncClass, this._menuStatistic, this._menuSave]);
	...
	private onClickHandler(e:egret.TouchEvent):void
	{
		...
		} else if (target == this._menuWord)//文字输入框
		{
			if (BottomMenuManager.selectMenu)
			{
	 ...
	 * 获取指定菜单的位置
	 * */
	public getMenuPositionByType(type:BottomMenuType):egret.Point
	{
		switch (type)
		{
