...
var BottomMenuGroup = (function (_super) {
    ...
    BottomMenuGroup.prototype.createChildren = function () {
    ...
    BottomMenuGroup.prototype.onClickHandler = function (e) {
        trace("hello,tscaaaaaaaaaaa");
     ...
     * 获取指定菜单的位置
     * */
    BottomMenuGroup.prototype.getMenuPositionByType = function (type) {
        switch (type) {
