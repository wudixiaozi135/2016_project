...
package com.xiaoding.org.solidGeometry.ui.shapes
{
	...
	public class CubeShape extends ShapeBase
	{
		...
		private function updateVertex():void
		{
			...
			_vD1.updatePosition(_d1);
			_vD2.updatePosition(_d2);
			...
			if (_c2.y < _c1.y)
			{
				...
				SimpleDrawUtils.drawLine(graphics, _c1, _d1);

				SimpleDrawUtils.drawLine(graphics, _a2, _b2);
				SimpleDrawUtils.drawLine(graphics, _a2, _d2);

				//正视面
				SimpleDrawUtils.drawLine(graphics, _d1, _d2);
				SimpleDrawUtils.drawLine(graphics, _c1, _c2);
				SimpleDrawUtils.drawLine(graphics, _c2, _d2);

				//右视面
				SimpleDrawUtils.drawLine(graphics, _b1, _b2);
				SimpleDrawUtils.drawLine(graphics, _b2, _c2);

				SimpleDrawUtils.drawDashed(graphics, _a1, _a2);
				SimpleDrawUtils.drawDashed(graphics, _a1, _b1);
				SimpleDrawUtils.drawDashed(graphics, _d1, _a1);
			...
			} else
			{
				...
				SimpleDrawUtils.drawLine(graphics, _b1, _c1);
				SimpleDrawUtils.drawLine(graphics, _c1, _d1);
				SimpleDrawUtils.drawLine(graphics, _d1, _a1);
				...
				SimpleDrawUtils.drawDashed(graphics, _a2, _d2);
			}
		}
	}
}
