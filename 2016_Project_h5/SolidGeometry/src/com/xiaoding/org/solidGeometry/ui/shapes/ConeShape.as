...
package com.xiaoding.org.solidGeometry.ui.shapes
{
	...
	public class ConeShape extends ShapeBase
	{
		...
		private var LIMIT_HEIGHT:int = 50;
		...
		public function update(point:Point):void
		{
			...
			if (_endP.y < _startP.y)
			{
				...
				SimpleDrawUtils.drawLine(_pen.graphics, _startP, new Point(_startP.x - _radius, _startP.y + offP.y));
				SimpleDrawUtils.drawLine(_pen.graphics, _startP, new Point(_startP.x + _radius, _startP.y + offP.y));
			} else
			{
				SimpleDrawUtils.drawLine(_pen.graphics, _startP, new Point(_startP.x - _radius, _startP.y + offP.y));
