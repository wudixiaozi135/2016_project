package org.egret.java.app2048;
...
public class app2048 extends Activity
{
    ...
    private static final String EGRET_PUBLISH_ZIP = "game_code_160408113940.zip";
    protected static final String TAG = "app2048";
    ...
    private void setInterfaces()
    {
        ...
        gameEngine.setRuntimeInterface("GameExit", new IRuntimeInterface()
        {
            @Override
            public void callback(String message)
            {
