package org.egret.java.appBlackWhiteBlock;
...
public class appBlackWhiteBlock extends Activity
{
    ...
    private static final String EGRET_PUBLISH_ZIP = "game_code_160331162228.zip";
    protected static final String TAG = "appBlackWhiteBlock";
    ...
    private void setInterfaces()
    {
        ...
        gameEngine.setRuntimeInterface("exitGame", new IRuntimeInterface()
        {
            @Override
            public void callback(String message)
            {
