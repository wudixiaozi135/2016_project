 ...
 */
class GameTaskView extends egret.Sprite
{
	private static _instance:GameTaskView;
	...
	public static getInstance():GameTaskView
	{
	...
	public onShowTaskWindow(container:egret.Sprite, callFunc:Function = null)
	{
	...
	private _buyBtn1:KXButton;
	private _buyBtn2:KXButton;
	private _buyBtn3:KXButton;
	private _buyBtn4:KXButton;
	private _buyBtn5:KXButton;
	private _buyBtn6:KXButton;
	...
	private onSetPropertyByLocalStore()
	{
	...
	private onObtainTool1(evt:egret.TouchEvent):void
	{
	...
	private onObtainTool2(evt:egret.TouchEvent):void
	{
	...
	private onObtainTool3(evt:egret.TouchEvent):void
	{
	...
	private onObtainTool4(evt:egret.TouchEvent):void
	{
	...
	private onObtainTool5(evt:egret.TouchEvent):void
	{
	...
	private onObtainTool6(evt:egret.TouchEvent):void
	{
	...
	private onAddToolToLocalStore(num:number)
	{
