package org.egret.java.appHappyGlops;
...
public class appHappyGlops extends Activity {
    ...
    private static final String EGRET_PUBLISH_ZIP = "game_code_160506111703.zip";
    protected static final String TAG = "appHappyGlops";
